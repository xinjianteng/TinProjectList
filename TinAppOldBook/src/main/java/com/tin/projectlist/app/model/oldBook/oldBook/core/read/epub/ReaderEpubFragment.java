...
public class ReaderEpubFragment extends MvpLazyFragment<com.tin.projectlist.app.model.oldBook.core.read.epub.EpubPresenter> implements EpubContract.View {
    ...
    @Override
    protected com.tin.projectlist.app.model.oldBook.core.read.epub.EpubPresenter createPresenter() {
