...
public class GatherDynastyAdapter extends BaseRecyclerViewAdapter<Dynasty, GatherDynastyAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public GatherDynastyAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new GatherDynastyAdapter.ViewHolder(viewGroup, R.layout.item_fragment_gather_dynasty);
    }

    @Override
    public void onBindViewHolder(@NonNull GatherDynastyAdapter.ViewHolder holder, final int position) {
