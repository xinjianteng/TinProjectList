 ...
 */
package com.tin.projectlist.app.library.base.autosize;
...
import com.tin.projectlist.app.library.base.autosize.external.ExternalAdaptInfo;
import com.tin.projectlist.app.library.base.autosize.external.ExternalAdaptManager;
import com.tin.projectlist.app.library.base.autosize.internal.CancelAdapt;
import com.tin.projectlist.app.library.base.autosize.internal.CustomAdapt;
import com.tin.projectlist.app.library.base.autosize.utils.LogUtils;
import com.tin.projectlist.app.library.base.autosize.utils.Preconditions;
...
public final class AutoSize {
    ...
    public static void autoConvertDensity(Activity activity, float sizeInDp, boolean isBaseOnWidth) {
        ...
        LogUtils.d("autoConvertDensity " + activity + (activity instanceof CancelAdapt));
