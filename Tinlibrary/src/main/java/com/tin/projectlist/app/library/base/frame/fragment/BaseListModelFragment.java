...
public abstract class BaseListModelFragment<VM extends BaseViewModel, DB extends ViewDataBinding> extends BaseAppModelFragment<VM, DB> {
...
//            pageEntity.setSearchAfter(data.getSearchAfter());
