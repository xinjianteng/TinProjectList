...
public class RePaintStatus {
     ...
     * @param cursor 字符游标
     */
    public RePaintStatus(boolean isCurl, PageIndex pageIndex, GBTextWordCursor cursor) {
     ...
     */
    public RePaintStatus(boolean isCurl, PageIndex pageIndex, int chpFileIndex, int paragraphIndex, int wordIndex,
