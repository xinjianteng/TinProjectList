package com.tin.projectlist.app.library.reader.parser.util;
...
public final class MimeType {
	...
	public static final MimeType VIDEO_3GPP = get("video/3gpp");
	public static final MimeType MP3 = get("audio/x-mpeg");
	// ???
	...
	public static final MimeType APP_XHTML = get("application/xhtml+xml");
	...
	public static final List<MimeType> TYPES_FB2 = Collections
			.singletonList(TEXT_FB2);
	public static final List<MimeType> TYPES_EPUB = Collections
			.singletonList(APP_EPUB_ZIP);
	public static final List<MimeType> TYPES_MOBIPOCKET = Collections
			.singletonList(APP_MOBIPOCKET);
	public static final List<MimeType> TYPES_TXT = Collections
			.singletonList(TEXT_PLAIN);
	public static final List<MimeType> TYPES_RTF = Collections
			.unmodifiableList(Arrays.asList(APP_RTF, TEXT_RTF));
	public static final List<MimeType> TYPES_HTML = Collections
			.singletonList(TEXT_HTML);
	public static final List<MimeType> TYPES_PDF = Collections
			.singletonList(APP_PDF);
	public static final List<MimeType> TYPES_DJVU = Collections
			.unmodifiableList(Arrays.asList(IMAGE_VND_DJVU, IMAGE_XDJVU));
	public static final List<MimeType> TYPES_DOC = Collections
			.singletonList(APP_MSWORD);
	public static final List<MimeType> TYPES_FB2_ZIP = Collections
			.singletonList(APP_FB2_ZIP);
