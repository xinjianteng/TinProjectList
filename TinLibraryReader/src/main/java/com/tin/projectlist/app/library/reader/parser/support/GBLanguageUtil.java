...
public abstract class GBLanguageUtil {
    ...
    public static GBFile patternsFile() {
        return GBResourceFile.createResourceFile("languagePatterns");
    }
    ...
    public static String languageByIntCode(int languageCode, int subLanguageCode) {
        switch (languageCode) {
            ...
            case 0x2D :
                return "eu"; // Basque
            case 0x2E :
                return (subLanguageCode == 0x08) ? "dsb" // Lower Sorbian
                        : "wen"; // Upper Sorbian
            case 0x2F :
