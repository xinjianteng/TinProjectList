...
public final class GBTextTeXHyphenationPattern {
	...
	public GBTextTeXHyphenationPattern(char[] pattern, int offset, int length, boolean useValues) {
		if (useValues) {
			int patternLength = 0;
	...
	public boolean equals(Object o) {
		GBTextTeXHyphenationPattern pattern = (GBTextTeXHyphenationPattern)o;
		int len = myLength;
