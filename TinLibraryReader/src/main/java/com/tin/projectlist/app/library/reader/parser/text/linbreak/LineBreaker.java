...
//		init();
//	}
	static LineBreakerInterface mBreakerInterface;
	public static void setmBreakerInterface(LineBreakerInterface mBreakerInterface) {
		LineBreaker.mBreakerInterface = mBreakerInterface;
	}
...
//	private static native void setLineBreaksForString(String data, String lang, byte[] breaks);
	...
	public void setLineBreaks(char[] data, int offset, int length, byte[] breaks) {
		mBreakerInterface.setLineBreaksForCharArray(data, offset, length, myLanguage, breaks);
	}

	public void setLineBreaks(String data, byte[] breaks) {
		mBreakerInterface.setLineBreaksForString(data, myLanguage, breaks);
	}
}
