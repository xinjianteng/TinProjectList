 ...
 * 创建日期：2013-4-2<br>
 */
final class GBDTDParser {
	private static final byte IGNORABLE_WHITESPACE = 0;//可无视的空白区
	private static final byte LANGLE = 1;//
	private static final byte TAG_PREFIX = 2;//tag前缀
	private static final byte COMMENT = 3;//内容
	...
	/**
	 * 解析stream，将DTD实体存入eneityMap中
	 *
	 * @param stream 输入流（DTD格式文件）<br>
	 * @param entityMap 实体健值对
	 * @throws IOException
	 * @author fuchen
	 * @date 2013-4-10
	 */
