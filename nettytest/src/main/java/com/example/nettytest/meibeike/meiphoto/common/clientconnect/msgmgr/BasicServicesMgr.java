...
import com.example.nettytest.meibeike.meiphoto.common.clientconnect.ClientConnectorManager;
...
public class BasicServicesMgr extends BaseClientMgr {
  ...
  private BasicServicesMgr() {
    super( "192.168.10.184", 2229, ClientConnectorManager.BASIC_SERVICES_MGR_KEY);
  }
