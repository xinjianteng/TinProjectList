...
public class PermissionUtils {
    ...
    public static boolean havePermission(Context mContext,String permissionName){
        return ActivityCompat.checkSelfPermission(mContext,permissionName) != PackageManager.PERMISSION_GRANTED;
    }
