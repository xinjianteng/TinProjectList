...
import com.tin.library.utils.AutoUtils;
...
public final class ToastUtils {
     ...
     *              白色样式：{@link com.cliff.libs.util.toast.style.ToastWhiteStyle}
     *              仿QQ样式：{@link com.cliff.libs.util.toast.style.ToastQQStyle}
     */
    ...
    private static int dp2px(Context context, float dpValue) {
        return AutoUtils.getBase(dpValue);
    }
    ...
    private static int sp2px(Context context, float spValue) {
        return AutoUtils.getBase(spValue);
    }
