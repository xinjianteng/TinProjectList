...
final class ToastHelper implements Runnable {
    ...
    static final int SHORT_DURATION_TIMEOUT = 4000; // 短吐司显示的时长
    static final int LONG_DURATION_TIMEOUT = 7000; // 长吐司显示的时长

    static final int SHORT_DURATION_DELAY = 2000; // 短吐司延时的时长
    static final int LONG_DURATION_DELAY = 3000; // 长吐司延时的时长
