...
public class AutoUtils {
    ...
    public static boolean getIsBaseOnWidth() {
        float base = SCREEN_HEIGHT / SCREEN_WIDTH;
        float real = (float) ScreenUtil.getScreenHeight(AppSprite.INSTANCE) / ScreenUtil.getScreenWidth(AppSprite.INSTANCE);
        return real > base;
    }
     ...
     * @return
     */
    public static int getBase(float dp) {
        if (getIsBaseOnWidth()) {
            return getBase(dp, INDEX_BASE_WIDTH);
        }
        return getBase(dp, INDEX_BASE_HEIGHT);
    }
     ...
     * @return
     */
    public static int getDividerWidth(int dp) {
        return ScreenUtil.getScreenWidth(AppSprite.INSTANCE) - AutoUtils.getBase(dp);
    }
}
